...
description: 'Mandatory for every pkg-common-util task, including analysis, clarification, planning, implementation, review, debugging, documentation, public API work, skill maintenance, and validation. Use before every narrower skill.'
---
...
Load this skill before doing any work in `pkg-common-util`, including read-only
